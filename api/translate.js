...
export default async function handler(req, res) {
    ...
    try {
        ...
        const basePrompt = "Translate the subtitles in this file into Vietnamese with the following requirements: \n" +
                    ...
                    "Detect proper nouns (e.g., names of people, places, or organizations) and convert them into Sino-Vietnamese pronunciation. Ensure the first letter of each word in pinyin is capitalized.\n" +
